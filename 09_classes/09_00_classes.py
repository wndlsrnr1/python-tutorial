...
# ==================================================
# Python Scopes and NAMESPACE_DNS
# Before introducing classes, I first have to tell you something about Python's scope rules. Class definitions play some neat tricks with namespaces, and you need to know how scpes and namesapces work to fully understand what's going on. Icidentally, knowledge about this subject is useful for any advanced Python programmer.
...
# Examples of namespaces are: the set of built-in names (containing functions such as abs(), and built-in exception names); the global names in a module; and the local names in a function invocation.In a sense the set of attributes of an object also from a namespace. The important thing to know about namespaces is that there is absolutely no relation between names; for instance, two diffrent modules may both define a function maximize without confusion users of the modules must prefix it with the module name.
#
# By the way, I use the word attribute for any name following a dot -- for example, in the expression z.real, real is an attribute of the object z. Strictly speaking, references to names in modules are attribute of it. In this case there happens to be a straightforward mapping between the module's at-attributes and the global names defined in the module: they share the same namespace!
# ==================================================
